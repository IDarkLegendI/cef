let menu = new Vue({
    ...
    data: {
        ...
        { name: 'Lamborghini Performante 18', model: '18performante', price: 275000, s100: '3.7', s200: '0' },
        { name: 'T-20', model: 't20', price: 270000, s100: '3.7', s200: '0' },
        { name: 'Porsche-811', model: 'pfister811', price: 50000, s100: '3.9', s200: '0' },
        { name: 'Dubsta 6x6', model: 'dubsta3', price: 34000, s100: '7.2', s200: '0' },
        { name: 'Lamborghini Urus', model: 'urus', price: 178000, s100: '3.9', s200: '0' },
        { name: 'Porsche Taycan', model: 'taycan', price: 178000, s100: '2.6', s200: '0' },
        { name: 'Tesla Model X', model: 'teslax', price: 185000, s100: '2.9', s200: '6.0' },
        { name: 'Bentley Bentayga', model: 'bentayga17', price: 42000, s100: '4.1', s200: '14.0' },
        ...
        { name: 'BANSHEE', model: 'banshee', price: 30000, s100: '5.8', s200: '0' },
        { name: 'Nissan GT-R', model: '17r35', price: 35500, s100: '5.3', s200: '0' },
        { name: 'COQUETTE', model: 'coquette4', price: 70000, s100: '5.7', s200: '0' },
        { name: 'DEVESTE', model: 'deveste', price: 170000, s100: '8.0', s200: '0' },
        { name: 'ELEGY', model: 'elegy2', price: 28500, s100: '5.6', s200: '0' },
        { name: 'HOTRING', model: 'hotring', price: 40200, s100: '5.2', s200: '0' },
        { name: 'ITALI', model: 'italigto', price: 50000, s100: '3.4', s200: '0' },
        ...
        { name: 'FMJ', model: 'fmj', price: 230000, s100: '4.5', s200: '0' },
        ...
        { name: 'SHEAVA', model: 'sheava', price: 220000, s100: '4.9', s200: '0' },
        ...
        { name: 'SHOTARO', model: 'shotaro', price: 280000, s100: '3.8', s200: '0' },
        { name: 'SANCTUS', model: 'sanctus', price: 80000, s100: '5.4', s200: '0' },
        { name: 'VORTEX', model: 'vortex', price: 110000, s100: '4.0', s200: '0' },
        ...
        { name: 'RR Cullinan', model: 'cullinan', price: 230000, s100: '9.4', s200: '0' },
        { name: 'BMW M5', model: 'bmci', price: 270000, s100: '3.9', s200: '11.2' },
        { name: 'AUDI RS7', model: 'rs7c8', price: 270000,  s100: '3.9', s200: '11.2'},
        { name: 'PORSCHE 911R', model: '911r', price: 270000, s100: '3.9', s200: '11.2'},
        { name: 'tdf', model: 'tdf', price: 270000,  s100: '3.9', s200: '11.2'},
        { name: '19raptor', model: '19raptor', price: 270000,  s100: '3.9', s200: '11.2'}, 
        { name: 'LADA NIVA', model: 'urban', price: 13000,  s100: '3.9', s200: '11.2'},  
        { name: '4runner', model: '4runner', price: 270000,  s100: '3.9', s200: '11.2'},].sort((a, b) => a.price - b.price),
        carsPointer: 0,
        myCar: 'none',
        camRotation: -90,
        oldColor: [0, 0, 0, 'none'],
